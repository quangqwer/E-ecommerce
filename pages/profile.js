...
const Profile = () => {
    ...
    const updatePassword = (name, email) => {
    ...
    const changeAvatar = (e) => {
        ...
        if (file.size > 1024 * 1024 * 5) return dispatch({ type: 'NOTIFY', payload: { error: 'The largest img size is 5mb.' } })
                ...
                <div className="col-md-4">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" name="name" value={name} className="form-control"
                            placeholder="Your name" onChange={handlerChange} />
                    </div>

                    <div className="form-group">
                        <label htmlFor="email">Email</label>
                        <input type="text" name="email" defaultValue={auth.user.email}
                            className="form-control" placeholder="Your name" disabled={true} onChange={handlerChange} />
                    </div>

                    <div className="form-group">
                        <label htmlFor="password">New Password</label>
                        <input type="password" name="password" value={password} className="form-control"
                            placeholder="Your new password" onChange={handlerChange} />
                    </div>

                    <div className="form-group">
                        <label htmlFor="cf_password">Confirm new Password</label>
                        <input type="password" name="cf_password" value={cf_password} className="form-control"
                            placeholder="Confirm new password" onChange={handlerChange} />
                    </div>
